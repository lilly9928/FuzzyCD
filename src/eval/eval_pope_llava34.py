...
parser.add_argument("--gt_files", type=str, default="/data3/KJE/code/WIL_DeepLearningProject_2/Hallu_MLLM/base/VCD/experiments/data/POPE/coco/coco_pope_popular.json")
parser.add_argument("--gen_files", type=str, default="/data3/KJE/code/WIL_DeepLearningProject_2/Hallu_MLLM/output/final/llava16M_coco_pope_popular_answers_seed55_debuging_log_softmax_jsd_final.jsonl")
