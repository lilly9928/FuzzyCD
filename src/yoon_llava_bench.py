...
from utils.image_filter import add_filter, add_filter_whoo
...
###preprocess for membership function 
    sample_size = int(len(dataset) * 0.1)  # 전체 길이의 10%
    ...
    for line in tqdm(sampled_questions):
       ...
       ##인풋 바꾸기 
        ...
        if args.use_cd:
            ...
            ##add_filter_whoo 는 이미지 자체를 받아옴 . 이미지 주소가 아님 
        ...
        with torch.inference_mode():
            ...
            # print(logits_means_mean,logits_means_std,logits_min,logits_max)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filter_type", type=str, default='gussian')
