...
def sample(
    ...
    **model_kwargs,
    ...
    input_ids_cd = None
    # print(input_ids.equal(model_kwargs.get("input_ids_cd")))
    # print(input_ids)
    # print(model_kwargs.get("input_ids_cd"))
    ...
    while True:
        ...
        if model_kwargs_cd is None:
            # print("initial model_kwargs_cd is None")
            ...
            if use_cd:
                ...
                model_kwargs_cd["attention_mask"] = generationMixin._prepare_attention_mask_for_generation(
                    model_kwargs_cd.get("input_ids_cd"), pad_token_id, eos_token_id
                )
        ...
        # if model_kwargs.get("attention_mask").equal(model_kwargs.get("attention_mask_cd")):
        #     print("attention_mask and attention_mask_cd are the same")
        # else:
        #     print(model.kwargs.get("attention_mask"))
        #     print(model.kwargs.get("attention_mask_cd"))
