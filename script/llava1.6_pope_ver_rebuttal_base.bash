...
seed=${1:-55}
model_path=${4:-"liuhaotian/llava-v1.6-vicuna-13b"}
cd_alpha=${5:-0.7}
cd_beta=${6:-0.2}
noise_step=${7:-500}
...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=0,3,4 python ./src/object_hallucination_vqa_llava_ver2_base.py \
      ...
      --answers-file ./output/final/llava16M_${dataset_name}_pope_${type}_answers_seed${seed}_debuging_log_softmax_jsd_final_base_2.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
