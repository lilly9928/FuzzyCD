...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=4 python /data3/KJE/code/WIL_DeepLearningProject_2/Hallu_MLLM/src/object_hallucination_vqa_llava_ver2_chair.py  \
      ...
      --question-file /data3/KJE/code/WIL_DeepLearningProject_2/Hallu_MLLM/base/ICD/experiments/data/chair/chair-val.json \
      --image-folder ${image_folder} \
      --answers-file ./output/final/llava15M_${dataset_name}_32.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
