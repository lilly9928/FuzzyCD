...
seed=${1:-55}
model_path=${4:-"liuhaotian/llava-v1.5-mlp2x-336px-pretrain-vicuna-13b-v1.5"}
...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=1,2 python ./src/object_hallucination_vqa_llava.py \
      ...
      --answers-file ./output/llava16M_${dataset_name}_pope_${type}_answers_seed${seed}_test_.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
