...
datasets=("coco" )
filters=( "FLL+sobel")
# filters=("FLL+median" "FLL+sobel" "FLL+median" "FLL+bilateral")
...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    for filter in "${filters[@]}"; do
      ...
      CUDA_VISIBLE_DEVICES=1 python ./src/object_hallucination_vqa_llava_ver2.py \
        ...
        --answers-file ./output/final/llava15M_${dataset_name}_pope_${type}_answers_seed${seed}_debuging_log_softmax_jsd_final_${filter}_2.jsonl \
        --cd_alpha $cd_alpha \
        --filter_type ${filter} \
        --cd_beta $cd_beta \
