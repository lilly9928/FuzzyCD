...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=2 python ./src/object_hallucination_vqa_llava_ver2.py \
      ...
      --answers-file ./output/final/llava15M_${dataset_name}_pope_${type}_answers_seed${seed}_debuging_log_softmax_jsd_final_sharpen_test_debug.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
