...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=1,2 python ./src/object_hallucination_vqa_instructblip_Fuzzy_base.py \
      ...
      --answers-file ./output/final/instructblip_Fuzzy_${dataset_name}_pope_${type}_answers_seed${seed}_final_Sobal_base_Sampling.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
