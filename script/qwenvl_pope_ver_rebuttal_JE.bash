...
model_path=${4:-"Qwen/Qwen2.5-VL-3B-Instruct"}
cd_alpha=${5:-0.7}
cd_beta=${6:-0.2}
noise_step=${7:-500}
...
for dataset_name in "${datasets[@]}"; do
  ...
  for type in "${types[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=2,3,4 python ./src/object_hallucination_vqa_qwenvl_2.py \
      ...
      --answers-file ./output/final/qwen25vl_${dataset_name}_pope_${type}_answers_seed${seed}_test.jsonl \
      --cd_alpha $cd_alpha \
      --cd_beta $cd_beta \
